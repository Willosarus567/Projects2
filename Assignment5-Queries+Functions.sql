...
DECLARE @min INT
SELECT @min = min(Room_Rate)
FROM dbo.PriceRange(40, 160)
INSERT INTO Rooms(Room_Id, Tavern_Id, Room_Status, Floor, Date_Info, Room_Rate) 
VALUES(  6, 4, 'Vacant', 2, '1999-09-09', @min-.01 ); 
