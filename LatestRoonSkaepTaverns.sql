...
CREATE TABLE Payments_Recieved(
    ...
    Tavern_id INT,
    Guest_Id INT,
    PRIMARY KEY(Payment_Recieved_Id, Service_Id)
    
    /*ALTER TABLE Payments_Recieved ADD FOREIGN KEY(Payment_Recieved_Id) REFERENCES Sales(Sale_Id)*/
    FOREIGN KEY(Tavern_Id) REFERENCES Taverns(Tavern_Id),
...
CREATE TABLE Sales(
    ...
    Tavern_Id INT,
    FOREIGN KEY(Service_Id) REFERENCES Payments_Recieved(Service_Id)
);

INSERT INTO Sales(Sale_Id, Supply_Id, Service_Id, Guest_Id, Price, Sale_Date, Sale_Amount, Tavern_Id)

        VALUES(1, NULL ,1, 3, 20.00, '2007-12-30', 20.00, 1),
              (2, NULL ,5, 16, 12000.00, '2007-12-30', 10000.00, 1),
              (3, NULL ,3, 5, 40.00, '2008-01-21', 320.00, 1),
              (4, NULL ,3, 21, 160.00, '2008-02-15', 320.00, 3),
              (5, NULL ,3, 2, 40.00, '2008-03-10', 80.00, 1),
              (6, NULL ,5, 10, 90.00, '2008-04-13', 90.00, 1),
              (7, NULL ,5, 3, 110.00, '2007-12-30', 110.00, 1),
              (8, NULL ,5, 16, 5070.00, '2007-12-30', 5070.00, 1),
              (9, NULL ,3, 23, 110.00, '2008-01-21', 220.00, 3),
              (10, NULL ,3, 18, 110.00, '2008-02-15', 550.00, 3),
              (11, NULL ,3, 14, 160.00, '2008-03-10', 320.00, 3),
              (12, NULL ,5, 11, 390.00, '2008-04-13', 390.00, 1),
              (13, NULL ,5, 23, 2240.00, '2008-03-10', 2240.00, 1),
              (14, NULL ,5, 10, 590.00, '2008-04-13', 590.00, 1);
